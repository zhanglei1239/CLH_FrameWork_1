...
#pragma mark - 创建一个背景广告 用于下拉刷新展示
-(UIImageView *)backImageWithName:(NSString * )imageName{
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        //注释:张磊 2015-10-13 下拉刷新增加广告条 模仿微博
//        [self addSubview:_backImage = [self backImageWithName:RefreshBackImage]];
...
//     //0.背景 注释:张磊 2015-10-13 下拉刷新增加广告条 模仿微博
//    _backImage.frame = CGRectMake(0, 0, frame.size.width, frame.size.height);
    // 1.状态标签
